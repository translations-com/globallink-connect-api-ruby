...
module UserProfileMappingRegistry
  UserProfileEncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  UserProfileLiteralRegistry = ::SOAP::Mapping::LiteralRegistry.new
  ...
  UserProfileEncodedRegistry.register(
  ...
  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::Notification,
    :schema_type => XSD::QName.new(NsXsd, "Notification"),
    :schema_element => [
      ["errorMessage", "SOAP::SOAPString"],
  ...
  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::GetSubmitters,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getSubmitters"),
    :schema_element => [
  ...
  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::GetSubmittersResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getSubmittersResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::UserProfile[]", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")], [0, nil]]
    ]
  )

  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::CreateUser,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "createUser"),
    :schema_element => [
      ["userInfo", "Glexchange::Pdws::UserInfo"],
      ["tiUserInfo", "Glexchange::Pdws::TiUserInfo"]
    ]
  )

  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::CreateUserResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "createUserResponse"),
    :schema_element => [
      ["v_return", ["SOAP::SOAPString[]", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")], [0, nil]]
    ]
  )

  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::GetCurrentUserLanguagesResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getCurrentUserLanguagesResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Language[]", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")], [0, nil]]
    ]
  )

  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::GetUserLanguages,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getUserLanguages"),
    :schema_element => [
      ["userTicket", "SOAP::SOAPString"]
    ]
  )

  UserProfileLiteralRegistry.register(
    :class => Glexchange::Pdws::GetUserLanguagesResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getUserLanguagesResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Language[]", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")], [0, nil]]
    ]
  )
  ...
  UserProfileLiteralRegistry.register(
    ...
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::UserProfile", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")]]
    ]
  )
end
