...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}getSubmitters
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}getSubmittersResponse
class GetSubmittersResponse < ::Array
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}createUser
#   userInfo - Glexchange::Pdws::UserInfo
#   tiUserInfo - Glexchange::Pdws::TiUserInfo
class CreateUser
  attr_accessor :userInfo
  attr_accessor :tiUserInfo

  def initialize(userInfo = nil, tiUserInfo = nil)
    @userInfo = userInfo
    @tiUserInfo = tiUserInfo
  end
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}createUserResponse
class CreateUserResponse < ::Array
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}getCurrentUserLanguagesResponse
class GetCurrentUserLanguagesResponse < ::Array
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}getUserLanguages
#   userTicket - SOAP::SOAPString
class GetUserLanguages
  attr_accessor :userTicket

  def initialize(userTicket = nil)
    @userTicket = userTicket
  end
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}getUserLanguagesResponse
class GetUserLanguagesResponse < ::Array
end
...
#   m_return - Glexchange::Pdws::UserProfile
