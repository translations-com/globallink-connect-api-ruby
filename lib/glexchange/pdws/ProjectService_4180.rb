...
#   m_return - Glexchange::Pdws::Project
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}findProjectByName
#   projectName - SOAP::SOAPString
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}findProjectByNameResponse
#   m_return - Glexchange::Pdws::Project
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}findProjectByShortCode
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}findProjectByShortCodeResponse
#   m_return - Glexchange::Pdws::Project
...
# {http://impl.services.service.ws.projectdirector.gs4tr.org}getUserProjects
#   isSubProjectIncluded - SOAP::SOAPBoolean
class GetUserProjects
  attr_accessor :isSubProjectIncluded

  def initialize(isSubProjectIncluded = nil)
    @isSubProjectIncluded = isSubProjectIncluded
  end
end

# {http://impl.services.service.ws.projectdirector.gs4tr.org}getUserProjectsResponse
class GetUserProjectsResponse < ::Array
end
