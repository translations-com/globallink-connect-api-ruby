...
module ProjectMappingRegistry
  ProjectEncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  ProjectLiteralRegistry = ::SOAP::Mapping::LiteralRegistry.new
  ...
  ProjectEncodedRegistry.register(
  ...
  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::Notification,
    :schema_type => XSD::QName.new(NsXsd, "Notification"),
    :schema_element => [
      ["errorMessage", "SOAP::SOAPString"],
  ...
  ProjectLiteralRegistry.register(
    ...
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Project", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")]]
    ]
  )

  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::FindProjectByName,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "findProjectByName"),
    :schema_element => [
      ["projectName", "SOAP::SOAPString"]
    ]
  )
  ...
  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::FindProjectByNameResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "findProjectByNameResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Project", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")]]
    ]
  )
  ...
  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::FindProjectByShortCode,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "findProjectByShortCode"),
    :schema_element => [
  ...
  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::FindProjectByShortCodeResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "findProjectByShortCodeResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Project", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")]]
    ]
  )
  ...
  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::GetUserProjects,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getUserProjects"),
    :schema_element => [
      ["isSubProjectIncluded", "SOAP::SOAPBoolean"]
    ]
  )

  ProjectLiteralRegistry.register(
    :class => Glexchange::Pdws::GetUserProjectsResponse,
    :schema_name => XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "getUserProjectsResponse"),
    :schema_element => [
      ["v_return", ["Glexchange::Pdws::Project[]", XSD::QName.new(NsImplServicesServiceWsProjectdirectorGs4trOrg, "return")], [0, nil]]
    ]
  )
end
